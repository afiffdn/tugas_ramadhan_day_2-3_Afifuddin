...
class WordListAdapter : ListAdapter<TableName, WordListAdapter.WordViewHolder>(WORDS_COMPARATOR) {
    ...
    companion object {
        private val WORDS_COMPARATOR = object : DiffUtil.ItemCallback<TableName>() {
